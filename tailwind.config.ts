...
const config = {
  ...
  content: [
    ...
    // './components/**/*.{ts,tsx}', // Not needed
    // './app/**/*.{ts,tsx}', // Not needed
    "./src/**/*.{ts,tsx}", // Keep this for explicit clarity if preferred
  ],
  theme: {
    container: {
      center: true,
  ...
  plugins: [
    animatePlugin, // Add the animate plugin
    // Removed require("tailwindcss-animate") as we import it now
  ],
} satisfies Config; // Use satisfies for better type checking
